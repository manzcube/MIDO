...
const Dashboard = () => {
  ...
  return (
    <div className='m-10 flex flex-col justify-start lg:px-52'>
      <h1 className='text-4xl text-sky-600 mb-8 font-bold md:text-5xl lg:text-7xl md:mt-60'>MIDO</h1>
      ...
      <div className="flex">
        <Link to={`/${token ? "today" : "login"}`} className='flex items-center bg-sky-600 text-white text-sm rounded-lg p-2 my-6 hover:shadow-xl transition-all duration-300'>
          Get Started
