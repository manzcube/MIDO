...
const RoleForm = ({ onChange, onSubmit, inputProps }) => {
  return (
    <form onSubmit={onSubmit} className="flex flex-col border rounded-lg mb-4 px-3 pb-2 w-44">
        <input 
        ...
        <input 
            ...
            onChange={onChange} 
        />
        <button type='submit' className='p-1 bg-gray-800 text-white rounded-md mt-1 text-xs'>Make Role</button>
      </form>
  )
}
