  ...
  return (
    <React.Fragment>
      ...
      <div
        ...
        } flex-col items-end p-5 mt-10 fixed w-full bg-white text-blue-600 z-40 space-y-3 rounded-md md:hidden`}
      >
        <Link
          to="/today"
          className="py-2 px-5 w-full text-end rounded hover:bg-blue-300 hover:text-white"
        >
          Today
        </Link>
        <Link
